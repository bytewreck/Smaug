...
namespace Smaug
{
    class Printer
    {
        ...
        private static void WriteLine(ConsoleColor color, string prefix, string format, params object[] args)
        {
            lock (Console.Out)
            {
                Console.ForegroundColor = color;
                Console.WriteLine(format.Insert(0, prefix.PadRight(4)).Replace("\n", "\n" + prefix.PadRight(4)), args);
                Console.ResetColor();
            }
        }
    }
